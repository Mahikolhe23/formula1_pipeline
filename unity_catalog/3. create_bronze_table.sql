...
USING json
OPTIONS (path 'abfss://bronze@databricksadlsexternal.dfs.core.windows.net/drivers.json')
...
USING json
OPTIONS (path 'abfss://bronze@databricksadlsexternal.dfs.core.windows.net/results.json')
